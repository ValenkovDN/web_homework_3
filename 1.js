...
const celsius = prompt("Введите температуру в °C: ")
converter(celsius);
function converter (temperatur) {
    let fahrenheit = Math.floor((Number.parseFloat((9 / 5) * temperatur + 32)) * 10)/ 10;
    alert(`${temperatur}°C по цельсию - это  ${fahrenheit}°F по фаренгейту.`);
}